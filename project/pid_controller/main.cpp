...
int main ()
{
  ...
  **/
  ...
  //Student Notes
  // pid_steer created is line number 232
  ...
  **/
    //Student Notes
  // pid_throttle created is line number 233

  PID pid_steer = PID();
  PID pid_throttle = PID();

  //Initialize PID values reference section PID Control in Udacity and
...
//           // Update the delta time with the previous command
          ...
          // Compute steer error
          double error_steer = 0.0; //Set default value is 0.0


          double steer_output = 0.0; //Set default value is 0.0
          ...
          **/
          ...
          double error_throttle = 0.0; //Set default value is 0.0
          /**
